                        ...
                        <div class="wsus__pro_details_text">
                            ...
                            <div class="wsus__selectbox">
                                <div class="row">
                                    ...
                                    <div class="col-xl-6 col-sm-6">
                                        <h5 class="mb-2 fw-bold text-primary">{{ $variant->name }}</h5>
                                        <select class="select_2" name="state">
                                            
                                            @foreach ($variant->productVariantItems as $variantItem)
                                            <option {{ $variantItem->is_default == 1 ? 'selected' : ''  }}>{{ $variantItem->name }} {{ $variantItem->price == 0 ? '' : $variantItem->price}}</span></option>
                                            @endforeach
                                        </select>
                                    </div>
                                    @endforeach
